			...
			<form class="form-horizontal" id="frm" action="mercadoria.do"
				...
				<p class="" id="pTipo">
					<label for="tipo">Tipo:</label> <br /> <input class="form-control"
						type="text" name="txtTipo" id="tipo">
				</p>
				...
				<p class="" id="pPreco">
					<label for="preco">Preço:</label> <br /> <input
						...
						id="preco" step="0.01" min="0">
				</p>

				<p>
					<label>Tipo de Negócio:</label> <br /> <label
				...
				<input type="submit" value="Salvar" onclick="return validar()"
					class="btn btn btn-primary"> <input type="button" value="Limpar"
					class="btn btn btn-primary" onclick="limpar()">
